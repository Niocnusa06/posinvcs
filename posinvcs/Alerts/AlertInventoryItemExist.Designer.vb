...
Partial Class AlertInventoryItemExist
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "Item name already exists."
        ...
        Me.Name = "AlertInventoryItemExist"
        Me.Text = "AlertInventoryItemExist"
